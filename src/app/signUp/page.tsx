    ...
    <div className="w-[1440px] h-[1561px]  m-auto font-agTitle">
      ...
      <div className="w-[1305px] h-[781px] mt-[76px] relative mr-[135px]">
        ...
        <div className="relative w-[371px] h-[781px] ml-[934px] bg-yellow border-0 border-black">
          <div className=" absolute w-[370px] h-[530px] mt-[125.5px] ">
            <div className="flex flex-col w-[339px] h-[78px]  ">
              <h1 className="w-[339px] h-[30px] text-[36px] font-medium tracking-wider -mt-[9px] text-Text2">
                Create an account
              </h1>
              <p className="w-[191px] [24px] text-[16px] mt-[24px] tracking-wider font-normal text-Text2">
              ...
              <div className="w-[370px] h-[404px]  mt-[48px]">
                ...
                <input
                  type="text"
                  className="w-[370px] ml-[0.5px] text-[16px] font-normal tracking-widest mt-[40px] h-[32px] border-0 border-b-2 border-gray-500  outline-none pb-1"
                  placeholder="Email ur Phone Number"
                />
                <input
                  type="text"
                  className="w-[370px] ml-[0.5px] text-[16px] font-normal tracking-widest mt-[40px] h-[32px] border-0 border-b-2 border-gray-500  outline-none pb-1"
                ...
                />
                <button className=" w-[370px] h-[56px] tracking-wider bg-secondary2 rounded-md hover:bg-opacity-80 flex justify-center items-center mt-[40px] text-Text text-[16px] font-normal">
                  Create Account
                </button>
